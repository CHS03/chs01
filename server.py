from flask import Flask, request, render_template# flask.py 안에 Flask class 로드 
# request 요청 관련 클래스~
# render_template html 로드하는 클래스
...
def detect():
    # request 관련 페이지들은
    # route 설정시 반드시 전송방식을 정의해야한다
    
    # GET -> request.args['Key값']
    # POST -> request.form['Key값']
    # POST,file -> request.files['Key값']
